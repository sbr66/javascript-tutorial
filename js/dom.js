...
// aElm.textContent = "<h1>insert text</h1>";
// bElm.innerHTML = "<h1>insert text</h1>";
...
// aElm.setAttribute("class", "a");
// const bElmAttr = bElm.getAttribute("id");
//console.log(bElmAttr);
// - 클릭하여 사진 바꾸기
// 1) DOM 요소 선택
...
const changeImg = (index) => {
  //화살표 함수는 반복문에서 전달된 DOM객체를 this로 전달받지 않고 전역 객체인 windnow가 선택된다.
